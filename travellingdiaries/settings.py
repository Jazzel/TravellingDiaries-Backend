"""
Django settings for travellingdiaries project.
...
SECRET_KEY = 'a(n(a_hh_$pr%estgjmgfnsvo-45_359clqj1!b3@-a259b%vd'
...
WSGI_APPLICATION = 'travellingdiaries.wsgi.application'
